	...
	<div class="container">
		<div class="row pt-xl">
			<div class="col-md-7">
				...
				<p class="lead mb-xl mt-lg">Bize ulaşmak için aşşağıda yer alan iletişim formunu doldurarak gönderebilirsiniz.</p>
			...
			<div class="col-md-4 col-md-offset-1">
				...
				<ul class="list list-icons list-icons-style-3 mt-xlg mb-xlg">
					<li><i class="fa fa-map-marker"></i> <strong>Address: </strong><?php echo $ayarcek['ayar_adres']; ?> <br> <?php echo $ayarcek['ayar_ilce']; ?> / <?php echo $ayarcek['ayar_il']; ?></li>
					<li><i class="fa fa-phone"></i> <strong>Phone:</strong> <?php echo $ayarcek['ayar_tel']; ?> </li>
				...
				<iframe
				src="https://www.google.com/maps/embed/v1/place?key=<?php echo $ayarcek['ayar_gmaps'];  ?>
				&q=<?php echo $ayarcek['ayar_adres']; ?> "
				width: "100%"
				height:"100%" 
				frameborder="0" 
				style="border:0"
