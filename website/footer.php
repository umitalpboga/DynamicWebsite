	<footer class="short" id="footer">
					...
					<div class="row">
						<div class="col-md-5">
							<a href="demo-law-firm.html" class="logo mb-md">
								<img alt="Porto Website Template" class="img-responsive" width="97" height="32" src="<?php echo $ayarcek['ayar_logo']; ?>">
							</a>
						...
						<div class="col-md-3 col-md-offset-1">
							...
							<ul class="list list-icons mt-xl">
								<li><i class="fa fa-map-marker"></i> <strong>Address: </strong> <?php echo $ayarcek ['ayar_adres']; ?>
								<br><?php echo $ayarcek ['ayar_ilce']; ?> / <?php echo $ayarcek ['ayar_il']; ?> </li>
								<li><i class="fa fa-envelope"></i> <strong>Mail:</strong> <a href="mailto:mail@example.com"><?php echo $ayarcek ['ayar_mail']; ?></a></li>
							</ul>
						</div>
						<div class="col-md-3">
							<h5 class="mb-sm">İletişim Kanallari</h5>
							...
							<ul class="social-icons mt-lg">
								...
								<li class="social-icons-linkedin"><a href="<?php echo $ayarcek ['ayar_youtube']; ?>" target="_blank" title="Linkedin"><i class="fa fa-youtube"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="footer-copyright">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<p>© Copyright 2020. All Rights Reserved. | <a href="https://www.yumit.com" target="blank"><?php echo $ayarcek ['ayar_author']; ?></a></p>
							</div>
						</div>
					</div>
				</div>
