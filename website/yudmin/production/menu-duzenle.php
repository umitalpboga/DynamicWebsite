...
<script src="//cdn.ckeditor.com/4.6.1/standard/ckeditor.js"></script>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <small>
                   ...
                   <?php }   ?>           
                    ...
                    <a style="float:right;" class="btn btn-warning" href="menu.php"><i class="fa fa-arrow-left" aria-hidden="true"></i> Geri Dön </a>
                  ...
                  <input type="hidden"  name="menu_id" value="<?php echo $menucek['menu_id']; ?>"></input>
                   ...
                   $menusor ->execute(array('menu_ust' => 0 ));
                    ?>
                    <?php  while( $menuck =$menusor->fetch(PDO::FETCH_ASSOC) )
                     { ?>

                            <option  value="<?php echo $menuck['menu_id']; ?>">
                            
                            <?php echo $menuck['menu_ad'];  ?>
  ...
  <div class="form-group">
    ...
    <div class="col-md-4 col-sm-4 col-xs-12">
    <select id="heard" class="form-control" name="menu_durum" >
        ...
        <div align="right" class="col-md-4 col-sm-4 col-xs-12 col-md-offset-3">
            <button type="submit"  name="menuduzenle" class="btn btn-primary">Düzenle</button>
