      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form action="../nedting/islem.php" method="post">
              ...
              <div>
               <button type="submit" class="btn btn-default" name="loggin"> Giriş Yap </button> 
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Yumit Yazılım</h1>
                  <p>©2020 Yumit yazılım tarafından kodlanmıştır.</p>
                </div>
              </div>
            </form>
          </section>
