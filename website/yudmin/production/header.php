...
$kullanicisor->execute(array('ad' => @$_SESSION['kullanici_ad']));
...
<html lang="en">
  <head>
    ...
    <title>Yumit Yazilim | Panel </title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>AEUmit Yazılım </span></a>
            </div>
