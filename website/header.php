...
include 'yudmin/nedting/baglan.php';
include 'yudmin/production/fonki.php';
	...
	<body>
		...
		<div class="body">
			<header id="header" class="header-no-border-bottom" data-plugin-options='{"stickyEnabled": true, "stickyEnableOnBoxed": true, "stickyEnableOnMobile": true, "stickyStartAt": 115, "stickySetTop": "-115px", "stickyChangeLogo": false}'>
							...
							<div class="header-search visible-lg">
								<form  action="arama.php" method="POST">
									<div class="input-group">
										<input type="text" minlength="3" class="form-control" name="aranan" placeholder="arama..." required>
				...
				<?php 
				   $menusor = $db->prepare("select * from menu where menu_ust =:menu_ust  and menu_durum=1 order by menu_sira ASC  ");
				 ...
				 {   
					...
					<li <?php if($say>0) {echo "class='dropdown'";} ?>>
						<a href="<?php 
